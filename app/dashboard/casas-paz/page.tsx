...
export default function CasasPazPage() {
  ...
  const activeFilterCount = [filterLiderSubred !== "all", filterLider !== "all", filterRed !== "all"].filter(
    Boolean,
  ).length
                                ...
                                {selectedCasa.sublideresNombres.map((nombre, index) => (
                                  <div key={index} className="p-3 bg-secondary rounded-lg">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                      {selectedCasa.subliderTelefonos[index]}
                                    </p>
                                  </div>
                                ))}
                              </div>
                                ...
                                <div className="md:col-span-2">
                                  ...
                                  <Select
                                    ...
                                    onValueChange={(value) =>
                                      setUpdateData({
                                        ...updateData,
                                        red: value as "Adultos" | "Jóvenes" | "Adolescentes",
                                      })
                                    }
                                  >
                                    <SelectTrigger className="bg-background border-border mt-1">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                  ...
                                  <Input
                                    ...
                                    onChange={(e) =>
                                      setUpdateData({ ...updateData, anfitrionTelefono: e.target.value })
                                    }
                                    className="bg-background border-border mt-1"
